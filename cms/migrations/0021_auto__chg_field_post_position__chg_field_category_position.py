...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cms_post', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Category.position'
        db.alter_column(u'cms_category', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Post.position'
        db.alter_column(u'cms_post', 'position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Category.position'
        db.alter_column(u'cms_category', 'position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        u'cms.contentrepository': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'unicore-cms-test-repo-django'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'targets': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['cms.PublishingTarget']", 'symmetrical': 'False'}),
            'url': ('django.db.models.fields.CharField', [], {'default': "'git@github.com:miltontony/unicore-cms-test-repo-django.git'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'cms.localisation': {
