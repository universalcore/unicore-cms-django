...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cms_category', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_height'
        db.add_column(u'cms_category', 'image_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_width'
        db.add_column(u'cms_category', 'image_width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cms_category', 'image')

        # Deleting field 'Category.image_height'
        db.delete_column(u'cms_category', 'image_height')

        # Deleting field 'Category.image_width'
        db.delete_column(u'cms_category', 'image_width')
    ...
    models = {
        ...
        u'cms.contentrepository': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'default': "'https://github.com/universalcore/unicore-cms-content-gem-tanzania'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'cms.localisation': {
