...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.last_author'
        db.add_column(u'cms_post', 'last_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='post_last_author', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Category.last_author'
        db.add_column(u'cms_category', 'last_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_last_author', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.last_author'
        db.delete_column(u'cms_post', 'last_author_id')

        # Deleting field 'Category.last_author'
        db.delete_column(u'cms_category', 'last_author_id')
