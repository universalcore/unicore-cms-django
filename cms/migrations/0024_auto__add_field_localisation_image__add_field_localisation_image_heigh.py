...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Localisation.image'
        db.add_column(u'cms_localisation', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Localisation.image_height'
        db.add_column(u'cms_localisation', 'image_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Localisation.image_width'
        db.add_column(u'cms_localisation', 'image_width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Localisation.image'
        db.delete_column(u'cms_localisation', 'image')

        # Deleting field 'Localisation.image_height'
        db.delete_column(u'cms_localisation', 'image_height')

        # Deleting field 'Localisation.image_width'
        db.delete_column(u'cms_localisation', 'image_width')
