...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.featured_in_category'
        db.add_column(u'cms_post', 'featured_in_category',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.featured_in_category'
        db.delete_column(u'cms_post', 'featured_in_category')
