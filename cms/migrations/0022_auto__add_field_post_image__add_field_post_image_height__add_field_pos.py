...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cms_post', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.image_height'
        db.add_column(u'cms_post', 'image_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.image_width'
        db.add_column(u'cms_post', 'image_width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cms_post', 'image')

        # Deleting field 'Post.image_height'
        db.delete_column(u'cms_post', 'image_height')

        # Deleting field 'Post.image_width'
        db.delete_column(u'cms_post', 'image_width')
