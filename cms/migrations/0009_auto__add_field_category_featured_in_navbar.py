...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.featured_in_navbar'
        db.add_column(u'cms_category', 'featured_in_navbar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.featured_in_navbar'
        db.delete_column(u'cms_category', 'featured_in_navbar')
