...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.uuid'
        db.add_column(u'cms_post', 'uuid',
        ...
        db.alter_column(u'cms_post', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Post.uuid'
        db.delete_column(u'cms_post', 'uuid')


        # Changing field 'Post.created'
        db.alter_column(u'cms_post', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
