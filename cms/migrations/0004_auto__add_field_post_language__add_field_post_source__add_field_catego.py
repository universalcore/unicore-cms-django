...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cms_post', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.source'
        db.add_column(u'cms_post', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Post'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.language'
        db.add_column(u'cms_category', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.source'
        db.add_column(u'cms_category', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.language'
        db.delete_column(u'cms_post', 'language')

        # Deleting field 'Post.source'
        db.delete_column(u'cms_post', 'source_id')

        # Deleting field 'Category.language'
        db.delete_column(u'cms_category', 'language')

        # Deleting field 'Category.source'
        db.delete_column(u'cms_category', 'source_id')
