...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding SortedM2M table for field related_posts on 'Post'
        db.create_table(u'cms_post_related_posts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_post', models.ForeignKey(orm[u'cms.post'], null=False)),
            ('to_post', models.ForeignKey(orm[u'cms.post'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'cms_post_related_posts', ['from_post_id', 'to_post_id'])

    def backwards(self, orm):
        # Removing M2M table for field related_posts on 'Post'
        db.delete_table(db.shorten_name(u'cms_post_related_posts'))
    ...
    models = {
        ...
        u'cms.post': {
            ...
            'related_posts': ('sortedm2m.fields.SortedManyToManyField', [], {'related_name': "'related_posts_rel_+'", 'to': u"orm['cms.Post']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255'}),
